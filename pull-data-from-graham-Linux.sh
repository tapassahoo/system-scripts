...
rsync -avze ssh graham:/scratch/tapas/rot-dens-asymmetric-top-plot/rot-dens-matrix-of-para-H2O-Temp5.000000Kelvin-Beads24/rho.den018 --exclude 'core.*' ${HOME}/academic-project/outputs/rotational-propagator-for-water/rho.den018_para
rsync -avze ssh graham:/scratch/tapas/rot-dens-asymmetric-top-plot/rot-dens-matrix-of-ortho-H2O-Temp5.000000Kelvin-Beads24/rho.den018 --exclude 'core.*' ${HOME}/academic-project/outputs/rotational-propagator-for-water/rho.den018_ortho
rsync -avze ssh graham:/scratch/tapas/rot-dens-asymmetric-top-plot/rot-dens-matrix-of-spin-less-H2O-Temp5.000000Kelvin-Beads24/rho.den018 --exclude 'core.*' ${HOME}/academic-project/outputs/rotational-propagator-for-water/rho.den018_spinless
